...
num_lines <- 90
col_palette <- PrettyCols::prettycols("Autumn")
s <- 1234
set.seed(s)
polygon1 <- sf::st_polygon(list(cbind(c(0, 1, 1, 0, 0), c(0, 0, 1, 1, 0))))
endpoints <- tibble::tibble(x = c(seq(0, 1, length = 100),
