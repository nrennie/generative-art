...
# Save examples
stream()
ggplot2::ggsave("Images/stream1.png", width = 4, height = 4)
...
ggplot2::ggsave("Images/stream2.png", width = 4, height = 4)
...
stream_circles <- function(n_x = 3, n_y = 3,
                   extra_span = 0.01,
                   n_grid = 1000,
                   bw = 0.75,
                   n_t = 30,
...
stream_circles()
ggplot2::ggsave("Images/stream3.png", width = 4, height = 4)


# List of color palettes --------------------------------------------------

stream_multi <- function(n_x = 3, n_y = 3,
                         extra_span = 0.01,
                         n_grid = 1000,
                         bw = 0.75,
                         n_t = 30,
...
stream_multi(
  n_x = 3, n_y = 3,
  col_palette_list = list(
    PrettyCols::prettycols("Lucent"),
    PrettyCols::prettycols("Greys"),
    PrettyCols::prettycols("Lucent"),
    PrettyCols::prettycols("Greys"),
    PrettyCols::prettycols("Lucent"),
    PrettyCols::prettycols("Greys"),
...
ggplot2::ggsave("Images/stream4.png", width = 4, height = 4)

set.seed(2024)
palettes <- lapply(PrettyCols::PrettyColsPalettes, function(x) x[[1]])[sample(16)]
stream_multi(n_x = 4, n_y = 4, col_palette_list = palettes)
ggplot2::ggsave("Images/stream5.png", width = 4, height = 4)
